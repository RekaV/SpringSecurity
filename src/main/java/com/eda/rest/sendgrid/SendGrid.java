...
public class SendGrid {
  ...
  //  private HttpHost host=new HttpHost("10.100.1.124",3128);
    /**
    ...
    public SendGrid(String username, String password) {
       ...
       // this.client = HttpClientBuilder.create().setProxy(host).setUserAgent(USER_AGENT).build();
    ...
    public SendGrid.Response send(Email email) throws SendGridException {
    	//HttpHost host=new HttpHost("10.100.1.124",3128);
        HttpPost httppost = new HttpPost(this.url + this.endpoint);
        //ConnRouteParams.setDefaultProxy(httppost, host);
