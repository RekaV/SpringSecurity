...
public class DialogService extends WatsonService {
	 ...
	 */
	public Conversation converse(final Map<String, Object> params) throws UnsupportedEncodingException {
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public Conversation createConversation(final String dialogId) throws UnsupportedEncodingException {
	 ...
	 * @see DialogService
	 */
	public void deleteDialog(final String dialogId) throws UnsupportedEncodingException {
		if (dialogId == null || dialogId.isEmpty())
			throw new IllegalArgumentException(
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public List<DialogContent> getContent(final String dialogId) throws UnsupportedEncodingException {
		if (dialogId == null || dialogId.isEmpty())
			throw new IllegalArgumentException(
					"dialogId can not be null or empty");
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public List<Dialog> getDialogs() throws UnsupportedEncodingException {
	 ...
	 * @see NameValue
	 */
	public List<NameValue> getProfile(String dialogId, Integer clientId) throws UnsupportedEncodingException {
		if (dialogId == null || dialogId.isEmpty())
			throw new IllegalArgumentException(
					"dialogId can not be null or empty");
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public List<ConversationData> getConversationData(final Map<String, Object> params) throws UnsupportedEncodingException {
		final String dialogId = (String) params.get(DIALOG_ID);
	 ...
	 * @see Dialog
	 */
	public void updateProfile(final String dialogId, final Integer clientId, final List<NameValue> nameValues) throws UnsupportedEncodingException {
		if (dialogId == null || dialogId.isEmpty())
			throw new IllegalArgumentException(
					"dialogId can not be null or empty");
